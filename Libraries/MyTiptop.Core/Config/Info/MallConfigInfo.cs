...
namespace MyTiptop.Core
{
    ...
    public class MallConfigInfo : IConfigInfo
    {
        ...
        private string _mallname = "brnmall网上商城购票cs配置";//商城名称
        private string _siteurl = "http://www.ddd.com cs配置";//网站网址
        private string _sitetitle = "brnmall网上商城购票222";//网站标题
        private string _seokeyword = "seo cs配置";//seo关键字
        private string _seodescription = "seo描述 cs配置";//seo描述
        private string _icp = "备案编号 粤B1001";//备案编号
        ...
        private string _password = "123456"; // 添加帐户默认用户密码
