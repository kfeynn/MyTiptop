...
//            int olid = MyTiptop.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
...
//            return MyTiptop.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
//        }
...
//        {
//            MyTiptop.Data.OnlineUsers.UpdateOnlineUserIP(olId, ip);
//        }
...
//        {
//            MyTiptop.Data.OnlineUsers.UpdateOnlineUserUid(olId, uid);
//        }
...
//        {
//            return MyTiptop.Data.OnlineUsers.GetOnlineUserBySid(sid);
//        }
...
//        {
//            return MyTiptop.Data.OnlineUsers.GetOnlineUserCount(userType);
//        }
...
//            int onlineAllUserCount = TypeHelper.ObjectToInt(MyTiptop.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT), -1);
//            if (onlineAllUserCount == -1)
//            {
//                onlineAllUserCount = GetOnlineUserCount(0);
//                MyTiptop.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT, onlineAllUserCount);
//            }
...
//            int onlineGuestCount = TypeHelper.ObjectToInt(MyTiptop.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT), -1);
//            if (onlineGuestCount == -1)
//            {
//                onlineGuestCount = GetOnlineUserCount(-1);
//                MyTiptop.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT, onlineGuestCount);
//            }
...
//        {
//            MyTiptop.Data.OnlineUsers.DeleteOnlineUserBySid(sid);
//        }
...
//            {
//                MyTiptop.Data.OnlineUsers.DeleteExpiredOnlineUser(BMAConfig.MallConfig.OnlineUserExpire);
...
//            try
//            {
//                MyTiptop.Data.OnlineUsers.ResetOnlineUserTable();
//            }
//            catch
//            {
//                try
...
//        {
//            return MyTiptop.Data.OnlineUsers.GetOnlineUserList(pageSize, pageNumber, locationType, locationId);
//        }
...
//        {
//            return MyTiptop.Data.OnlineUsers.GetOnlineUserCount(locationType, locationId);
//        }
//    }
//}
